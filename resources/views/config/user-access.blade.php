                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control font-weight-normal form-select2" id="user" name="user" data-placeholder="Select User" data-clear>
                                    </select>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="search" class="form-control" aria-controls="list_datatable" placeholder="Search">
                                    </div>
                                </div>
                            </div>
                        </div>
