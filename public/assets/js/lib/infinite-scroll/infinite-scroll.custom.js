        ...
        s.fn[i] = function(t, ...e) {
            return "string" == typeof t ? function(t, e, o) {
                ...
                return t.each((function(t, h) {
                    let a = s.data(h, i);
                    if (!a)
                        return void n(`${i} not initialized. Cannot call method ${l}`);
                    let c = a[e];
                    if (!c || "_" == e.charAt(0))
...
function(t, e) {
    ...
    r.create = function() {
        ...
        this.getPath && this.getPath()) {
            ...
            this.callOnInit();
            for (let t in s.create)
                s.create[t].call(this)
        } else
    ...
    r.updateGetPathSelector = function(t) {
        ...
        let i = e.getAttribute("href")
          , n = c(i);
        if (!n)
            return void console.error(`InfiniteScroll unable to parse next link href: ${i}`);
    ...
    return n && u && u("infiniteScroll", s, n),
    s
}
)),
function(t, e) {
    ...
    return i.loadNextPage = function() {
        ...
        let s = fetch(o, i).then((i=>{
            ...
            return i[t]().then((s=>("text" == t && e && (s = n.parseFromString(s, "text/html")),
        ...
        return this.dispatchEvent("request", null, [o, s]),
        s
    }
    ,
    ...
    i.appendNextPage = function(t, e, i) {
        ...
        if (!l || !l.length)
            return this.lastPageReached(t, e),
            h;
        let a = o(l)
          , c = ()=>(this.appendItems(l, a),
        this.isLoading = !1,
    ...
    ,
    i.resetPage = function(t, e, i) { // This is new function
        this.canLoad = !0,
        this.pageIndex = 1,
        this.loadCount = 0,
        this.loadNextPage()
...
function(t, e) {
    ...
    n.getBottomDistance = function() {
        ...
        i = this.scroller.scrollTop + this.scroller.clientHeight) : (e = this.top + this.element.clientHeight,
...
function(t, e) {
    ...
    n.onScrollHistory = function() {
        ...
        t != this.scrollPage && (this.scrollPage = t,
        this.setHistory(t.title, t.path))
    }
    ,
...
function(t, e) {
    ...
    function r(t, e, l) {
        ...
        a) ? (this.elements = (h = a,
        Array.isArray(h) ? h : "object" == typeof h && "number" == typeof h.length ? s.call(h) : [h]),
