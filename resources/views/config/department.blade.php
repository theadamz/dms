        ...
        <div class="modal" tabindex="-1" id="modalFormImport" data-backdrop="static" data-keyboard="false"
            ...
            <div class="modal-dialog modal-dialog-centered modal-md">
                <div class="modal-content position-absolute">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group fv-row">
                                        <label class="form-label font-weight-normal mb-1">File <span class="text-danger">*</span></label>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control font-weight-normal" rows="10" placeholder="Logs" id="logs" name="logs" readonly></textarea>
                                    </div>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="modal-footer justify-content-between">
                        <div class="d-flex">
                            <button type="button" form="formImport" class="btn btn-default mr-2" data-dismiss="modal" id="cancelUpload" name="cancelUpload"><i class="fa fa-times mr-2"></i> Close
                            </button>
                            <a href="{{ route('template.download', ['template_name' => $templateName]) }}" target="_blank" class="btn btn-primary" id="template" name="template"><i class="fa fa-download mr-2"></i> Template
                            </a>
                        </div>
                        <button type="submit" form="formImport" class="btn btn-success" id="upload" name="upload" formaction="javascript:;">
