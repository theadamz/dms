...
function initDataTable() {
    _dataTable = $('#list_datatable').DataTable({
        ...
        "ajax": {
            "url": `${_baseURL}/dt/configs/departments`,
            "type": "GET",
            "data": function (d) {
...
async function saveData() {
    ...
    // prepare url
    url = `${_baseURL}/configs/departments`;
...
async function editData(id = null) {
    ...
    // send request
    const response = await axiosCustom(`${_baseURL}/configs/departments/${_id}`, 'GET');
...
async function deleteData() {
    ...
    // send request
    const response = await axiosCustom(`${_baseURL}/configs/departments`, "DELETE", _data2Send);
...
async function importData() {
    ...
    // send request
    const response = await axiosCustom(`${_baseURL}/configs/departments/imports`, "POST", _data2Send, null);
...
async function exportData() {
    ...
    // get data
    const response = await axiosCustom(`${_baseURL}/configs/departments/exports`, 'POST', {
